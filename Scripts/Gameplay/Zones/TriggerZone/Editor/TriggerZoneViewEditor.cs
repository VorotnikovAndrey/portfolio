using Gameplay.Player.TriggerZone;
using UnityEngine;
using UnityEditor;

[CustomEditor(typeof(TriggerZoneView))]
public class TriggerZoneViewEditor : Editor
{
    private void OnSceneGUI()
    {
        var triggerZoneView = (TriggerZoneView)target;
